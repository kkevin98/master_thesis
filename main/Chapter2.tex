...
\begin{equation}
	...
	\end{gathered}
\end{equation}
Equation~\eqref{eqn:discretized_version_of_PDE_using_RBF-FD} can also be rewritten more compactly as
\begin{equation}
	\label{eqn:compact_discretized_PDE}
	\vec{C}_I \vec{u} = \vec{f} - \vec{C}_B \vec{u}_B
\end{equation}
